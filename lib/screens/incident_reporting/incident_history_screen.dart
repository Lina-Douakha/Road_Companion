        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              ...
              onPressed: _viewAllIncidentsOnMap,
            ),
          ],
        ),
              ...
              children: [
                ...
                if (isLoading)
                  ...
                  Expanded(
                    child: Column(
                      children: [
                        const SizedBox(height: 90), // Add space at the top to push content up
                        Expanded(
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.start, // push content to start (top)
                            children: <Widget>[
                              Lottie.asset(
                              ...
                              Text(
                                "incident_report.You_haven't_reported_any_incidents_yet".tr(),
                                style: const TextStyle(
                                  color: Colors.grey,
                                  fontSize: 16,
                                ),
