                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        _buildStatItem(
                          ...
                          incidentHistory
                              .where((i) => i['status'].toString().toLowerCase() == 'pending')
                              .length
                              .toString(),
                          Icons.access_time,
                          Colors.orange,
                        ...
                        _buildStatItem(
                          ...
                          incidentHistory
                              .where((i) => i['status'].toString().toLowerCase() == 'resolved')
                              .length
                              .toString(),
                          Icons.check_circle,
                          Colors.green,
                  ...
                  Expanded(
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          Image.asset(
                            'assets/images/no_incidents.png',
                            width: 150,
                            height: 150,
                          ),
                          const SizedBox(height: 16),
                          Text(
                            "No incidents reported".tr(),
                            style: const TextStyle(
                              color: Colors.grey,
                              fontSize: 18,
                              fontWeight: FontWeight.bold,
                          ...
                          Text(
                            "You haven't reported any incidents yet".tr(),
                            style: const TextStyle(
                              color: Colors.grey,
                              fontSize: 14,
                            ),
          ...
          child: Column(
            ...
            children: [
              ...
              if (hasImage) ...[
                const SizedBox(height: 16),
                Text(
                  "incident_report.Attached Image".tr(),
                  style: const TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 16,
                  ),
