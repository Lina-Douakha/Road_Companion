            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildHelpItem(Icons.call, "Assistance Téléphonique", "077********", url: "tel:077********"),
                  _buildHelpItem(Icons.email, "Email", "roacompanion@gmail.com", url: "mailto:roacompanion@gmail.com"),
                  _buildHelpItem(Icons.help_outline, "FAQ", "Trouver des réponses à vos questions"),
                  SizedBox(height: 20),
                  _buildSectionTitle("Lien"),
                  _buildHelpItem(Icons.facebook, "Académie nationale de sécurité routière",
                      "Rejoigner notre communauté sur Facebook",
