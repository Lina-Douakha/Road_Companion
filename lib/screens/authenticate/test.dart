...
class RegistrationScreen extends StatefulWidget {
  ...
  const RegistrationScreen({super.key, this.acceptedFromTerms = false});
...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  void initState() {
    super.initState();
    acceptedTerms = widget.acceptedFromTerms;
  }
          ...
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildTextField(
                  label: 'registration.username'.tr(),
