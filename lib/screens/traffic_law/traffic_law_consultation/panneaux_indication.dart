...
class PanneauxIndicationScreen extends StatefulWidget {
  const PanneauxIndicationScreen({super.key});

  @override
  _PanneauxIndicationScreenState createState() => _PanneauxIndicationScreenState();
}

class _PanneauxIndicationScreenState extends State<PanneauxIndicationScreen> {
    ...
    try {
      QuerySnapshot querySnapshot = await FirebaseFirestore.instance
         .collection(tr("database.courses"))
          ...
          .where("LawType", isEqualTo: "indication")
          .get();
