...
class PanneauxIntersectionScreen extends StatefulWidget {
  const PanneauxIntersectionScreen({super.key});

  @override
  _PanneauxIntersectionScreenState createState() => _PanneauxIntersectionScreenState();
}

class _PanneauxIntersectionScreenState extends State<PanneauxIntersectionScreen> {
  ...
  Future<void> _fetchPanneaux() async {
    try {
      QuerySnapshot querySnapshot = await FirebaseFirestore.instance
          ...
          .where("LawType", isEqualTo: "intersection")
          .get();
