...
class PanneauxInterdictionScreen extends StatefulWidget {
  const PanneauxInterdictionScreen({super.key});

  @override
  _PanneauxInterdictionScreenState createState() => _PanneauxInterdictionScreenState();
}

class _PanneauxInterdictionScreenState extends State<PanneauxInterdictionScreen> {
  ...
  Future<void> _fetchPanneaux() async {
    try {
      QuerySnapshot querySnapshot = await FirebaseFirestore.instance
          ...
          .where("LawType", isEqualTo: "interdiction")
          .get();
