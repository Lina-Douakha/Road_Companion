...
class TrafficLawScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Traffic Law', style: TextStyle(color: ColorsManager.white)),
        backgroundColor: ColorsManager.Bgreen,
        elevation: 0,
      ),
      backgroundColor: Colors.white, // ✅ Set background to completely white
            ...
            children: [
              ...
              ClickableCard(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => ChooseCategoryQuizScreen()),
                  );
                },
                screenWidth: screenWidth,
              ),
      ...
      bottomNavigationBar: BottomNavigationBar(
        currentIndex: 2,
        selectedItemColor: ColorsManager.Bgreen,
...
// ✅ **Stateful Clickable Card with Working Tap Effect**
...
class _ClickableCardState extends State<ClickableCard> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTapDown: (_) => setState(() => isTapped = true), // Press effect
      onTapUp: (_) => setState(() => isTapped = false), // Release effect
      onTapCancel: () => setState(() => isTapped = false), // Cancel effect
      onTap: widget.onTap,
      child: AnimatedContainer(
        ...
        height: 65,
        decoration: BoxDecoration(
          color: isTapped ? ColorsManager.Green1 : ColorsManager.Bgreen3, // Change color on press
